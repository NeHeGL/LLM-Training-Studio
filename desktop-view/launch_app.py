...
The server is launched separately by start_app.bat as its own console
...
Usage:
    ...
    — or double-click start_app.bat (auto-installs PyQt6 if missing)

The existing web UI (start_web.bat / browser) is completely unaffected.
...
# ── Consolidate __pycache__ at project root (same as start_app.bat) ──────────
...
def main():
    ...
    def _on_timeout():
        ...
        QMessageBox.critical(
            ...
            "Re-run start_app.bat to restart both the server and this app."
        )
        app.quit()
